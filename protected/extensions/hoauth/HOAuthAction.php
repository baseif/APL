  ...
  if ($type==1)
{
     ...
     else if ($type==0)
    {
        $Client->user_id = $profile->user_id ;
                  ...
                  //  $user = Client::model()->findByPk( $Client->user_id);
                                    $credit = new Credit;
                                    ...
                                    $Client->user_credits = $credit->credit_amount;
                   //$user->save(false);
                   ...
                   $credit_package->save(false);
                                    $credit_user->user_id =  $Client->user_id; //  hier muss der id zugewiesen  werden 
